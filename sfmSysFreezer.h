...
#define NT_DEVICE_NAME	L"\\Device\\sfmSysFreezer"
#define DOS_DEVICE_NAME	L"\\DosDevices\\sfmSysFreezer"

#define DBG_PRINT_ERR(_X) DbgPrint("sfmSysFreezer: Error - %wZ\n", _X) 
#define DBG_PRINT_WARN(_X) DbgPrint("sfmSysFreezer: Warning - %wZ\n", _X)
#define DBG_PRINT_INFO(_X) DbgPrint("sfmSysFreezer: Information - %wZ\n", _X)
...
typedef struct _SYS_FREEZER_DEVICE_EXTENSION
{
	DEVICE_TYPE		Type;
...
} SYS_FREEZER_DEVICE_EXTENSTION, *PSYS_FREEZER_DEVICE_EXTENSION;
